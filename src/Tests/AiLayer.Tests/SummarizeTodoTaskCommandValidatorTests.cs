...
public class SummarizeTodoTaskCommandValidatorTests
{
    private readonly SummarizeTodoTaskCommandValidator _validator = new();

    [Fact]
    public void Should_fail_when_todo_external_id_is_empty()
    {
        var command = new SummarizeTodoTaskCommand { TodoExternalId = Guid.Empty };
    ...
    {
        var command = new SummarizeTodoTaskCommand { TodoExternalId = Guid.NewGuid() };
